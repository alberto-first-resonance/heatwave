...
from pr_files_exporter import get_pr_files_graphql, process_prs, main
...
def test_process_prs(temp_files, github_params):
    ...
    with patch('pr_files_exporter.get_pr_files_graphql', return_value=mock_return_value):
...
def test_process_prs_error_handling(temp_files, github_params):
    ...
    with patch('pr_files_exporter.get_pr_files_graphql', side_effect=Exception("Test error")):
        # Capture print statements
...
def test_main_function(temp_files, github_params):
    """Test the main function with command line arguments"""
    input_csv_path, output_csv_path = temp_files
    
    test_args = [
        'pr_files_exporter.py',
    ...
    with patch('sys.argv', test_args):
        with patch('pr_files_exporter.process_prs') as mock_process:
            main()
